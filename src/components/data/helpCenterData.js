export const helpCenterData = {
  // Help Categories for main help center page
  helpCategories: [
    {
      id: 1,
  ...
  // FAQ Items for main help center page
  mainFaqItems: [
    {
      id: 1,
  ...
  // FAQ Categories for dedicated FAQ page
  faqCategories: [
    {
      id: 'orders-payments',
      title: 'Orders & Payments',
      faqs: [
        ...
        },
        {
          ...
          answer: 'Go to "My Orders" and select the order you want to modify or cancel. If the order has not been processed, you can edit or cancel it directly.'
        }
      ]
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: 'We offer standard, express, and same-day delivery options where available. Shipping costs vary based on location and delivery speed.'
        }
      ]
    },
    {
  ...
  // Help Categories Data for detailed pages
  helpCategoriesData: {
    'orders-payments': {
